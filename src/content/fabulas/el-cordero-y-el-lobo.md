...
resumen: Un cordero, a salvo dentro de la cabaña, provoca y fanfarronea ante el
...
traduccion: false
nota_curador: >-
  El cordero y el lobo pertenece a las Fábulas morales (1781-1784) que [Félix
  María de Samaniego](https://elfabulario.com/autores/felix-maria-de-samaniego/)
  escribió por encargo de la Real Sociedad Bascongada de los Amigos del País
  para el Real Seminario Patriótico Vascongado de Vergara, y aquí el fabulista
  invierte a propósito el argumento más conocido sobre estos dos animales —el
  del lobo que devora al cordero indefenso, fijado por Esopo, versificado por
  Fedro y popularizado en Europa por La Fontaine—: en esta pieza el cordero está
  a salvo tras los muros de la cabaña y es él quien provoca al lobo con una
  valentía de la que solo puede permitirse alarde por estar fuera de peligro; no
  se ha confirmado que Samaniego tomara este giro concreto de una fuente
  anterior, por lo que ese origen puntual se deja aquí como no establecido.


  ##### Glosario


  1. **Mamantón:** cría, en este caso el cordero, que todavía se alimenta de leche materna.

  2. **Pujanza:** fuerza o vigor.

  3. **Valentones:** los que fingen valentía o hacen alarde de ella sin tenerla en realidad.
---
