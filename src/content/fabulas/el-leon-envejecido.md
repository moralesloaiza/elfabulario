...
nota_curador: >-
  ...
  1. **Vasallaje:** sumisión u homenaje que un súbdito rinde a quien tiene poder sobre él; así describe Samaniego la actitud de los animales hacia el león cuando este aún era fuerte.

  2. **Jumento:** asno o burro; es la palabra que usa el león moribundo para nombrar, con desprecio, a quien le propina el último ultraje.

  3. **Cebarse:** ensañarse con alguien indefenso o ya vencido; el poema dice que los animales «cebados a porfía» se lanzan sobre el león caído.
---
Al miserable estado
