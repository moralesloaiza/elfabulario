...
export const PERSONAJES = [
	...
	// Plantas
	'aligustre', 'calabaza', 'castano', 'cedro', 'clematide', 'encina', 'estaca',
	'fresno', 'higuera', 'jazmin', 'lirio', 'melocotonero', 'nogal', 'olmo',
	'parietaria', 'peral', 'planta', 'rosa', 'salvia', 'sauce', 'te', 'tomillo',
	'vid',
	// Objetos
	'abanico', 'alforja', 'campana', 'candela', 'coche', 'eslabon', 'espada',
	'espejo', 'esquilon', 'lengua', 'manguito', 'navaja', 'papel', 'pedernal',
	'piedra', 'quitasol', 'red', 'tinta',
	// Elementos y partes del cuerpo
	'agua', 'diente', 'fuego', 'nariz', 'nieve', 'ojo',
	// Roles humanos
